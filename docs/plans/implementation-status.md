...
| CLI and release workflow | Partial | `.github/workflows/ci.yml`, `release.yml`; cross-platform CLI archives/checksums remain independent of the desktop workflow, which now uploads Tauri bundles with per-platform `SHA256SUMS` | Confirm tagged Tauri artifacts and add command-parity evidence (`MCAD-P1-002`–`MCAD-P1-003`) |
