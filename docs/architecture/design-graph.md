...
The Design Graph is OpenCAD's authoritative intermediate representation (IR). All regeneration, AI patches, and semantic diffs operate on this graph — not on cached B-Rep geometry.
