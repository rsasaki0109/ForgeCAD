...
<p align="center">
  <sub>360° turntable of <code>examples/bracket.ocad.d</code> — OCCT solid rendered headless via wgpu (studio lighting + gradient backdrop, <code>opencad turntable</code>)</sub>
</p>
